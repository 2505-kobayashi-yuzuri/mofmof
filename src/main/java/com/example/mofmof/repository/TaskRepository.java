...
public interface TaskRepository extends JpaRepository<Tasks, Integer> {
    List<Tasks> findAllByLimitDateBetweenAndStatusAndContentOrderByLimitDateAsc(Date startDate, Date endDate, Integer Status, String content);
    List<Tasks> findAllByLimitDateBetweenAndStatusOrderByLimitDateAsc(Date startDate, Date endDate, Integer Status);
